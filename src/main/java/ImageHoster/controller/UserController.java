...
public class UserController {
    ...
    //The user must only be registered if the password contains 1 alphabet, 1 number, and 1 special character. And after successful registration, you must directly return 'users/login' file.
    //Otherwise, the user must not be registered and again return the ‘users/registration’ file
    //set password type error in the Model type object with ‘passwordTypeError’ as the key.
